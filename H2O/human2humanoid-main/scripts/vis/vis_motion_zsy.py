...
def main_process(my_h1_xml,  my_h1_urdf,  my_motion_file,  my_asset_root):
    # # 机器人路径
    h1_xml  = my_h1_xml
    h1_urdf = my_h1_urdf
...
if __name__ == '__main__':
    robot_name = "h1"
    if robot_name == "g1":
        #pkl_name = "ACCAD_g1_punch1"
        pkl_name = "ACCAD_g1_stand1"
        path_xml = "../../resources/robots/g1/g1.xml"
        path_urdf = "resources/robots/g1/urdf/g1.urdf"
        path_motion_file = f"{MY_ROOT_DIR}/scripts/data_process/data/g1/{pkl_name}.pkl"
        path_asset_root = f"{MY_ROOT_DIR}" #修改下路径 这是总root
        main_process(path_xml,path_urdf,path_motion_file,path_asset_root)

    elif robot_name == "h1":
        pkl_name = "accad_h1_walk_1"
        path_xml = "../../resources/robots/h1/h1.xml"
        path_urdf = "resources/robots/h1/urdf/h1.urdf"
        path_motion_file = f"{MY_ROOT_DIR}/scripts/data_process/data/h1/{pkl_name}.pkl"
        path_asset_root = f"{MY_ROOT_DIR}" #修改下路径 这是总root
        main_process(path_xml,path_urdf,path_motion_file,path_asset_root)
    else:
        pass
