...
name = "stable_punch"
motion_file = f"/home/zhushiyu/文档/H2O/human2humanoid-main/scripts/data_process/data/h1/{name}.pkl"
...
# 根目录 zsy
# asset_root = "./" 原来    
asset_root = "/home/zhushiyu/文档/H2O/human2humanoid-main/" #修改下路径 这是总root
