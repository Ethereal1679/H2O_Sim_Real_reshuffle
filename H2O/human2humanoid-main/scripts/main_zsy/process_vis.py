...
def process_vis(my_h1_xml,  my_h1_urdf,  my_motion_file):
...
###########################################################################################################################
    ...
    gym.subscribe_viewer_keyboard_event(viewer, gymapi.KEY_A,           "add")
    gym.subscribe_viewer_keyboard_event(viewer, gymapi.KEY_P,           "print")
    gym.subscribe_viewer_keyboard_event(viewer, gymapi.KEY_B,           "next_batch")
    # gym.subscribe_viewer_keyboard_event(viewer, gymapi.KEY_s, "next_batch")
    motion_id = 0
    motion_acc = set()
    ...
    while not gym.query_viewer_has_closed(viewer):
        ...
        for evt in gym.query_viewer_action_events(viewer):
            if evt.action == "previous" and evt.value > 0:
                ...
                motion_acc.add(motion_keys[motion_id])    # 添加到motion_acc。。。
...
if __name__ == '__main__':
    ...
    if robot_name == "g1":
        pkl_name = "amass_accad_filtered_g1"
        path_xml = "../../resources/robots/g1/g1.xml"
        path_urdf = "resources/robots/g1/urdf/g1.urdf"
        path_motion_file = f"{MY_ROOT_DIR}/scripts/main_zsy/data_amass/g1_filtered/{pkl_name}.pkl"
        process_vis(path_xml, path_urdf,path_motion_file)
