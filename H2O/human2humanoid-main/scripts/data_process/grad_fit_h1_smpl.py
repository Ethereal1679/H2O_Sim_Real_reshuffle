...
# 重映射的关节的索引
h1_joint_pick_idx = [ h1_joint_names_augment.index(j) for j in h1_joint_pick] # [0, 1, 4, 5, 6, 7, 8, 12, 13, 14, 15, 16, 17, 18]
...
smpl_parser_n = SMPL_Parser(model_path=f"{MY_ROOT_DIR}/data/smpl", gender="male") # 路径需要修改
...
joblib.dump((shape_new.detach(), scale), "data/h1/shape_optimized_h1_male.pkl") # V2 has hip jointsrea
