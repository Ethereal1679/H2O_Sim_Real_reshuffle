...
if __name__ == "__main__":
    ...
    smpl_parser_n = SMPL_Parser(model_path=f"{MY_ROOT_DIR}/data/smpl",gender="male")
    smpl_parser_n.to(device)


    # 加载smpl
    shape_new, scale = joblib.load("data/h1/shape_optimized_h1_male.pkl")
    ...
    second_dir = "Male2MartialArtsStances_c3d"
    #third_dir = "E1 -  Jab left_poses"
    third_dir = "D1 - stand to ready_poses"
    ...
    for data_key in pbar:
        ...
        joblib.dump(data_dump, "./data/h1/ACCAD_h1_Male2MartialArtsPunches_c3d_E1.pkl") # name 可以自行更改
