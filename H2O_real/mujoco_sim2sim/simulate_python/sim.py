...
if __name__ == "__main__":
    ...
    target_dof_pos_test = default_angles.copy()
    ...
    band_attached_link = m.body("pelvis").id
    ...
    with mujoco.viewer.launch_passive(m, d, key_callback=elastic_band.MujuocoKeyCallback) as viewer:
        ...
        while viewer.is_running() and time.time() - start < simulation_duration:
            ...
            tau = pd_control(target_dof_pos_test, d.qpos[7:], kps, np.zeros_like(kds), d.qvel[6:], kds)
            d.ctrl[:] = tau
